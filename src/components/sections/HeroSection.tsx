...
const LOGO_H = 24; // uniform logo height in px

const integrations = [
  {
    name: "Strava",
    logo: (
      // Strava chevron mark (simple-icons path)
      <svg height={LOGO_H} viewBox="0 0 24 24" fill="white" style={{ display: "block" }}>
  ...
  },
  {
    ...
    logo: (
      ...
      <img
        src="https://cdn.mcmillanrunning.com/wp-content/uploads/2025/06/Training-Peaks.svg"
        alt="TrainingPeaks"
        style={{ height: LOGO_H, width: "auto", display: "block", filter: "brightness(0) invert(1)" }}
      />
    ),
  },
  {
    name: "Garmin",
    logo: (
      // Garmin wordmark (simple-icons path, viewBox trimmed to glyph bounds)
      <svg height={LOGO_H} viewBox="0 11.5 22.3 4.8" fill="white" style={{ display: "block", width: "auto" }}>
